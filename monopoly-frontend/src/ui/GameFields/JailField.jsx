...
export const JailField = (props) => {
	...
	return (
		...
		>
			Just Visiting
			<div className="bg-[#F7941D]  xl:w-52 2xl:w-60 border-2 border-black flex h-28 items-center space-x-4 justify-center text-xl md:text-2xl xl:text-4xl font-semibold">
